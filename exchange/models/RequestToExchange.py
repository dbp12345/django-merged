...
#
#
# # !!!!!!!!!!!!!! удалить эту модель, сделал её клон в Privser
# class Request_To_Exchange(models.Model):
...
#     contacts = models.ForeignKey("company.Employees", on_delete=models.CASCADE, related_name="request_to_exchange", blank=True, null=True)
#
